...
CREATE STREAM LINEITEM (
  ...
  FROM FILE './datasets/updates/lineitem.csv'
...
CREATE STREAM ORDERS (
  ...
  FROM FILE './datasets/updates/orders.csv'
  LINE DELIMITED CSV (delimiter := '|', predefined_batches := 'true');
...
CREATE STREAM CUSTOMER (
  ...
  FROM FILE './datasets/updates/customer.csv'
  LINE DELIMITED CSV (delimiter := '|', predefined_batches := 'true');
...
CREATE TABLE NATION (
  ...
  FROM FILE './datasets/updates/nation.csv'
