#ifndef APPLICATION_PATH_Q20_BASE_HPP
#define APPLICATION_PATH_Q20_BASE_HPP
...
#endif
#if defined(RELATION_R16_STATIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R16_entry>(
            "R16", dataPath + "/R16.tbl", '|', true,
            [](dbtoaster::data_t& data) {
                return [&](R16_entry& t) {
                    data.on_insert_R16(t);
                };
            }
    )));
#elif defined(RELATION_R16_DYNAMIC) && defined(BATCH_SIZE)
    typedef const std::vector<DELTA_R16_entry>::iterator CIteratorR16;
    relations.push_back(std::unique_ptr<IRelation>(
        new BatchDispatchableRelation<DELTA_R16_entry>(
            "R16", dataPath + "/R16.tbl", '|', false,
            [](dbtoaster::data_t& data) {
                return [&](CIteratorR16& begin, CIteratorR16& end) {
                    data.on_batch_update_R16(begin, end);
                };
            }
    )));
#elif defined(RELATION_R16_DYNAMIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R16_entry>(
            "R16", dataPath + "/R16.tbl", '|', false,
            [](dbtoaster::data_t& data) {
...
#endif
#if defined(RELATION_R17_STATIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R17_entry>(
            "R17", dataPath + "/R17.tbl", '|', true,
            [](dbtoaster::data_t& data) {
                return [&](R17_entry& t) {
                    data.on_insert_R17(t);
                };
            }
    )));
#elif defined(RELATION_R17_DYNAMIC) && defined(BATCH_SIZE)
    typedef const std::vector<DELTA_R17_entry>::iterator CIteratorR17;
    relations.push_back(std::unique_ptr<IRelation>(
        new BatchDispatchableRelation<DELTA_R17_entry>(
            "R17", dataPath + "/R17.tbl", '|', false,
            [](dbtoaster::data_t& data) {
                return [&](CIteratorR17& begin, CIteratorR17& end) {
                    data.on_batch_update_R17(begin, end);
                };
            }
    )));
#elif defined(RELATION_R17_DYNAMIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R17_entry>(
            "R17", dataPath + "/R17.tbl", '|', false,
            [](dbtoaster::data_t& data) {
...
#endif
#if defined(RELATION_R18_STATIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R18_entry>(
            "R18", dataPath + "/R18.tbl", '|', true,
            [](dbtoaster::data_t& data) {
                return [&](R18_entry& t) {
                    data.on_insert_R18(t);
                };
            }
    )));
#elif defined(RELATION_R18_DYNAMIC) && defined(BATCH_SIZE)
    typedef const std::vector<DELTA_R18_entry>::iterator CIteratorR18;
    relations.push_back(std::unique_ptr<IRelation>(
        new BatchDispatchableRelation<DELTA_R18_entry>(
            "R18", dataPath + "/R18.tbl", '|', false,
            [](dbtoaster::data_t& data) {
                return [&](CIteratorR18& begin, CIteratorR18& end) {
                    data.on_batch_update_R18(begin, end);
                };
            }
    )));
#elif defined(RELATION_R18_DYNAMIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R18_entry>(
            "R18", dataPath + "/R18.tbl", '|', false,
            [](dbtoaster::data_t& data) {
...
#endif
#if defined(RELATION_R19_STATIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R19_entry>(
            "R19", dataPath + "/R19.tbl", '|', true,
            [](dbtoaster::data_t& data) {
                return [&](R19_entry& t) {
                    data.on_insert_R19(t);
                };
            }
    )));
#elif defined(RELATION_R19_DYNAMIC) && defined(BATCH_SIZE)
    typedef const std::vector<DELTA_R19_entry>::iterator CIteratorR19;
    relations.push_back(std::unique_ptr<IRelation>(
        new BatchDispatchableRelation<DELTA_R19_entry>(
            "R19", dataPath + "/R19.tbl", '|', false,
            [](dbtoaster::data_t& data) {
                return [&](CIteratorR19& begin, CIteratorR19& end) {
                    data.on_batch_update_R19(begin, end);
                };
            }
    )));
#elif defined(RELATION_R19_DYNAMIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R19_entry>(
            "R19", dataPath + "/R19.tbl", '|', false,
            [](dbtoaster::data_t& data) {
...
#endif
#if defined(RELATION_R20_STATIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R20_entry>(
            "R20", dataPath + "/R20.tbl", '|', true,
            [](dbtoaster::data_t& data) {
                return [&](R20_entry& t) {
                    data.on_insert_R20(t);
                };
            }
    )));
#elif defined(RELATION_R20_DYNAMIC) && defined(BATCH_SIZE)
    typedef const std::vector<DELTA_R20_entry>::iterator CIteratorR20;
    relations.push_back(std::unique_ptr<IRelation>(
        new BatchDispatchableRelation<DELTA_R20_entry>(
            "R20", dataPath + "/R20.tbl", '|', false,
            [](dbtoaster::data_t& data) {
                return [&](CIteratorR20& begin, CIteratorR20& end) {
                    data.on_batch_update_R20(begin, end);
                };
            }
    )));
#elif defined(RELATION_R20_DYNAMIC)
    relations.push_back(std::unique_ptr<IRelation>(
        new EventDispatchableRelation<R20_entry>(
            "R20", dataPath + "/R20.tbl", '|', false,
            [](dbtoaster::data_t& data) {
...
#endif /* APPLICATION_PATH_Q20_BASE_HPP */
