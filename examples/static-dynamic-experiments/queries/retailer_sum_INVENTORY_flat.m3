...
DECLARE MAP V_top(long)[][locn: int, dateid: int] := V_rain_W1(long)[][locn, dateid]<Local> * V_zip_LC1(long)[][locn]<Local>;
...
ON SYSTEM READY {
  ...
  V_top(long)[][locn, dateid]<Local> := V_rain_W1(long)[][locn, dateid]<Local> * V_zip_LC1(long)[][locn]<Local>;
}