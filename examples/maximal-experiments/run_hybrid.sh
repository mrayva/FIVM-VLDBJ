...
# queries=("tpch_FQ1_eager tpch_FQ1_lazy")
# queries=("tpch-1-lazy" "tpch-1-eager")
queries=("tpch-1-hybrid")
...
dataset=$1
experiment_name="maximal"
method="F-IVM"

cd $WORK_DIR

# rm -rf "generated/m3/${experiment_name}"
# rm -rf "generated/cpp/${experiment_name}"
# rm -rf "bin/${experiment_name}"
...
do
    ...
    application_hpp="src/application/tpch/application_tpch_hybrid.hpp" 
