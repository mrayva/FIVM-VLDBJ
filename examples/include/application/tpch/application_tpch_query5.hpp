#ifndef APPLICATION_TPCH_QUERY5_HPP
#define APPLICATION_TPCH_QUERY5_HPP

#include <iostream>
#include "application.hpp"

class TpchQuery5Application : public Application {
 public:
...
std::unique_ptr<Application> createApplication() {
  return std::make_unique<TpchQuery5Application>();
}

#endif /* APPLICATION_TPCH_QUERY5_HPP */
